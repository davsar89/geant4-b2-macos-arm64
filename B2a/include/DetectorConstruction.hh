...
{
  public:
    // gdmlFile: optional GDML geometry that replaces the built-in B2 geometry
    explicit DetectorConstruction(const G4String& gdmlFile = "");
  ...
  private:
    ...
    G4String fGdmlFile;  // GDML geometry file (empty: built-in B2 geometry)
    G4GDMLParser fParser;  // also provides the /persistency/gdml/ commands
};
